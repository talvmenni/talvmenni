...
public class WhiteEnpassants implements WhiteEnpassant{

   private static WhiteEnpassants      instance;
   private static final long[] bitmaps = new long[64];
   
   public static Enpassant create() {
      if (WhiteEnpassants.instance == null) {
         WhiteEnpassants.instance= new WhiteEnpassants();
      }
      return WhiteEnpassants.instance;
   }

   private WhiteEnpassants() {
   }

   public long getPathsFrom(
         long square) {
      return WhiteEnpassants.bitmaps[Long.numberOfLeadingZeros(square)];
   }
