...
public class BlackEnpassants implements BlackEnpassant{

   private static BlackEnpassants      instance;
   private static final long[] bitmaps = new long[64];
   
   public static Enpassant create() {
      if (BlackEnpassants.instance == null) {
         BlackEnpassants.instance= new BlackEnpassants();
      }
      return BlackEnpassants.instance;
   }

   private BlackEnpassants() {
   }

   public long getPathsFrom(
         long square) {
      return BlackEnpassants.bitmaps[Long.numberOfLeadingZeros(square)];
   }
