...
public class ParallelIterativDeepeningAlphaBetaWithQuiescentAndTranspositionTableStrategy
   ...
   private ParallelIterativeDeepeningAlphaBetaWithQuiescentAndTranspositionTableMaster master;
   ...
   public ParallelIterativDeepeningAlphaBetaWithQuiescentAndTranspositionTableStrategy(
      ...
      try {
         this.master= new ParallelIterativeDeepeningAlphaBetaWithQuiescentAndTranspositionTableMaster();
   ...
   public static class ParallelIterativeDeepeningAlphaBetaWithQuiescentAndTranspositionTableMaster
         extends ChessEngineMaster {
      ...
      public ParallelIterativeDeepeningAlphaBetaWithQuiescentAndTranspositionTableResult bestResult;

      public ParallelIterativeDeepeningAlphaBetaWithQuiescentAndTranspositionTableMaster()
      ...
      protected void generateTasks() {
         ...
         if (this.numberOfTasks > 0) {
            for (Iterator it= moves.iterator(); it.hasNext();) {
               ...
               ChessEngineTask task= new ParallelIterativeDeepeningAlphaBetaWithQuiescentAndTranspositionTableTask(
                     childPosition,
                     move,
      ...
      protected void collectResults() {
         ParallelIterativeDeepeningAlphaBetaWithQuiescentAndTranspositionTableResult template= new ParallelIterativeDeepeningAlphaBetaWithQuiescentAndTranspositionTableResult();
         this.bestResult= null;
         template.ply= new Integer(
               this.collectAtPly);
         for (int i= 0; i < this.numberOfTasks; i++) {
            ParallelIterativeDeepeningAlphaBetaWithQuiescentAndTranspositionTableResult result= null;
            try {
               System.err.println("Starting to collect "
                     ...
                     + this.collectAtPly
                     + " ply");
               result= (ParallelIterativeDeepeningAlphaBetaWithQuiescentAndTranspositionTableResult) this
                     .takeResult(template);
   ...
   public static class ParallelIterativeDeepeningAlphaBetaWithQuiescentAndTranspositionTableTask
      ...
      public ParallelIterativeDeepeningAlphaBetaWithQuiescentAndTranspositionTableTask() {
      }
...
//         boolean taskIsSwapped= false;
         ...
         AlphaBetaWithQuiescentAndTranspositionTableSearch search= (AlphaBetaWithQuiescentAndTranspositionTableSearch) this.worker.search;
...
//               }
            ...
            if (localPly > (this.masterSearchedToPly.intValue())) {
               ...
               ParallelIterativeDeepeningAlphaBetaWithQuiescentAndTranspositionTableResult result= new ParallelIterativeDeepeningAlphaBetaWithQuiescentAndTranspositionTableResult();
               ...
               result.principalVariation= this.worker.search
...
//            }
       ...
       * @return
       */
      private ParallelIterativeDeepeningAlphaBetaWithQuiescentAndTranspositionTableTask getTaskFromSpace(
            ParallelIterativeDeepeningAlphaBetaWithQuiescentAndTranspositionTableTask swapTemplate) {
         ParallelIterativeDeepeningAlphaBetaWithQuiescentAndTranspositionTableTask result= null;
         ...
         try {
            ...
            if (trc != null) {
               ...
               tx= trc.transaction;
               result= (ParallelIterativeDeepeningAlphaBetaWithQuiescentAndTranspositionTableTask) ServiceLocator
                     .getJavaSpaceInstance().takeIfExists(
                           swapTemplate,
                           tx,
                           5000L);
               if (result != null) {
   ...
   public static class ParallelIterativeDeepeningAlphaBetaWithQuiescentAndTranspositionTableResult
         extends Result {
      ...
      public ParallelIterativeDeepeningAlphaBetaWithQuiescentAndTranspositionTableResult() {
      }
   }
