...
public class TestSpeedOnKnightAttacks {
   ...
   public static void main(
      ...
      System.out.println(" Asking for knight attacks "
            + howMany
            + " times...");
      ...
      long[] from= {Square._C3, Square._G1, Square._D1, Square._F6};
      
      for (int i= 0; i < howMany; i++) {
         long attacks= Knight.attacksFrom(from[i % 4], p);
      }
